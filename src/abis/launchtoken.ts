export const launchtokenAbi = [
  ...
  {
    "type": "event",
    "name": "LauncherTransferred",
    "inputs": [
      {
        "name": "previousLauncher",
        "type": "address",
        "indexed": true,
        "internalType": "address"
      },
